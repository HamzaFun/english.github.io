...
<body id="sign-body">
    ...
    <section class="main-des">
        ...
        <div class="main">
            ...
            <c:choose>
            <c:when  test="${ ! empty ses_rech }"> 
            <c:forEach items="${ ses_rech }" var="vg">
            <div class="des-ville">
                <!-- une description sur cette ville -->
                <div class="description">
                    <div class="img-des">
                        <img src="<c:url value="${ vg.lien }"/>" alt="l'image de ${ vg.ville }" />
                        <div class="desc">
                        	<c:choose>
                            ...
                            <form action="<c:url value="/Add_demande_ses"> <c:param name="recherch" value="R"/></c:url>" method="POST">
            ...
            <c:otherwise>
            <h2 class="text-center vide">Aucune voyage dans ce type... </h2>
            </c:otherwise>
            </c:choose>
        </div>
        <!-- l'icon de Panier -->
